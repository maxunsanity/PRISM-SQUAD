...
### `src/eventSystem/prize-drop_end/game_data/01_slot_lightning.csv`
...
### `src/eventSystem/prize-drop_end/game_data/02_multiplier.csv`
...
### `src/eventSystem/prize-drop_end/game_data/03_milestone.csv`
...
### `src/eventSystem/prize-drop_end/game_data/04_board_obstacle.csv`
