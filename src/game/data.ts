...
export const CSV_PATHS = {
  PLAYER:          '/tables/player_config.csv',
  ENEMY:           '/tables/enemy_config.csv',
  BOSS:            '/tables/boss_config.csv',
  WAVE:            '/tables/wave_config.csv',
  MAP:             '/tables/map_config.csv',
  SKILL:           '/tables/skill_config.csv',
  PROJECTILE:      '/tables/projectile_config.csv',
  SKILL_LEVEL:     '/tables/skill_level_config.csv',
  SKILL_EVOLUTION: '/tables/skill_evolution_config.csv',
  DROP:            '/tables/drop_config.csv',
  LEVEL:           '/tables/level_config.csv',
  VFX:             '/tables/vfx_config.csv',
  TALENT:          '/tables/talent_config.csv',
  TALENT_COST:     '/tables/talent_cost_config.csv',
  CONTROL:         '/tables/control_config.csv',
  STAGE:           '/tables/stage_config.csv',
  LUCKY_TRAIN:     '/tables/lucky_train_config.csv',
  TICKET:          '/tables/ticket_config.csv',
  ELEMENT:         '/tables/element_config.csv',
  EQUIPMENT:       '/tables/equipment_config.csv',
  WEAPON:          '/tables/weapon_config.csv',
  WEAPON_VISUAL:   '/tables/weapon_visual_config.csv',
  COMBAT_TUNING:   '/tables/combat_tuning.csv',
  ADVENTURE:       '/tables/adventure_config.csv',
  CHALLENGE:       '/tables/challenge_config.csv',
  EVOLUTION_TREE:  '/tables/evolution_config.csv',
  RUSH:            '/tables/rush_config.csv',
  META:            '/tables/meta_config.csv',
  SHOP_TEST:       '/tables/shop_test_config.csv',
  SHOP_GEM_PACK:   '/tables/shop_gem_pack.csv',
  SHOP_GOLD_PACK:  '/tables/shop_gold_pack.csv',
  SHOP_BOX:        '/tables/shop_box.csv',
  SHOP_BOX_GRADE:  '/tables/shop_box_grade.csv',
  FORMATION_SPAWN: '/tables/formation_spawn_config.csv',
  RUSH_CYCLE:      '/tables/rush_cycle_config.csv',
  LAVA_QUEST_HOST: '/tables/lava_quest_host_config.csv',
  TICKET_MULT_STEP:'/tables/ticket_multiplier_step.csv',
  EVENT_MINIGAME_HOST: '/tables/event_minigame_host_config.csv',
  EVENT_MINIGAME_ACQUIRE: '/tables/event_minigame_acquire_config.csv',
  EVENT_MINIGAME_KILL_REWARD: '/tables/event_minigame_kill_reward_config.csv',
  SKILL_RUNTIME:       '/tables/skill_runtime_config.csv',
  GUARDIAN_RUNTIME:    '/tables/guardian_runtime_config.csv',
  BOSS_PATTERN:        '/tables/boss_pattern_config.csv',
  LEVELUP_RULE:        '/tables/levelup_rule_config.csv',
  PLAYER_VISUAL:       '/tables/player_visual_config.csv',
  RENDERER:            '/tables/renderer_config.csv',
} as const;
