...
`+SA(s.getShaderSource(t),h)}else return l}function EA(s,t){const i=MA(t);return[`vec4 ${s}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
...
`].filter(ko).join(`
`)),h=Od(h),h=w0(h,i),h=D0(h,i),d=Od(d),d=w0(d,i),d=D0(d,i),h=U0(h),d=U0(d),i.isRawShaderMaterial!==!0&&(P=`#version 300 es
...
`)+`
`+v);const N=P+S+h,D=P+v+d,q=A0(l,l.VERTEX_SHADER,N),H=A0(l,l.FRAGMENT_SHADER,D);l.attachShader(A,q),l.attachShader(A,H),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function O(I){if(s.debug.checkShaderErrors){const J=l.getProgramInfoLog(A).trim(),$=l.getShaderInfoLog(q).trim(),ut=l.getShaderInfoLog(H).trim();let gt=!0,z=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(gt=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,A,q,H);else{const K=C0(l,q,"vertex"),X=C0(l,H,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
